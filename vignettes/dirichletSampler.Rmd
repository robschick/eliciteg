...
## Now we move on to the males. 
__Question 12__ - Consider a population of 100 adult __male__ right whales that are present in the northern regions during December and move _south_ to the mid-Atlantic during January.
...
nreg <- length(regNorth) # This will be used to divide down the Betas
