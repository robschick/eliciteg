...
dir2 <- floor(rgamma(9, 4, 0.5));dir2[dir2 == 0] <- 1
...
a
round(K, 3)
idx <- which.min(abs(K - a)) # I am not sure if this is the right algorithm
# I experimented with findInterval(), but couldn't get what I wanted
