...
Now I should be able to capture this with `lapply()`, i.e. do it in a really R-ish way.
...
Ok, so that's done, now what is next. I need to use these lists to sample $k_i$, and then to use that to choose the prior. Here it is for one question using Jim's algorithm.
