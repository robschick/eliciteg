...
Right. Now I need to do it for all questions. In the Gibbs loop, we loop over months and regions. And we have both males and females to update. So let's have different male and female data.
...
Now we'll try this in a more realistic Gibbs loop for both sexes
