...
Our function to assemble this matrix is `calck`. _a priori_ the prior weights for $K$ are equal to 1 / the number of experts, i.e. we give them equal weight. `calcK` returns the posterior weights for the experts.
